...
#
# 1. This project restoration tcl script (ExtraTimingOpt.tcl) that was generated.
#
...
set script_file "ExtraTimingOpt.tcl"
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu49dr-ffvf1760-2-e -flow {Vivado Implementation 2021} -strategy "Performance_ExtraTimingOpt" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
