...
#
# 1. This project restoration tcl script (ExploreWithRemap.tcl) that was generated.
#
...
set script_file "ExploreWithRemap.tcl"
...
set_property -name "board_part" -value "xilinx.com:zcu216:part0:2.5" -objects $obj
...
set_property -name "platform.ip_cache_dir" -value "/tmp/tmp.S6vazQvS27/temp/hwflow/hwflow_project_1/project_1.cache/ip" -objects $obj
...
set file "project_1/project_1.bd"
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu49dr-ffvf1760-2-e -flow {Vivado Synthesis 2021} -strategy "Flow_PerfOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu49dr-ffvf1760-2-e -flow {Vivado Implementation 2021} -strategy "Performance_ExploreWithRemap" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
